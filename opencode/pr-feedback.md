...
4. **Process valid comments one by one**
...
5. **Skip verification during fixes**
...
6. **Final verification (after all comments processed)**
...
8. **Resolve comments and post summary**
